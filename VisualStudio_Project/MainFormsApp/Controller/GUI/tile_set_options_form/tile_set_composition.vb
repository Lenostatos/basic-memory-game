Namespace controller.gui.game_setup
    ...
    Public Class tile_set_composition
        ...
        Public Sub list_design_selection_patterns(combo_box As ComboBox)
            ...
            combo_box.Items.Add(New KeyValuePair(Of ui.game_setup.tile_set_composition.how_to_select_designs, String)(
                                ui.game_setup.tile_set_composition.how_to_select_designs.only_identical_designs_per_item,
                                "Only identical tiles per item"))
            combo_box.Items.Add(New KeyValuePair(Of ui.game_setup.tile_set_composition.how_to_select_designs, String)(
                                ui.game_setup.tile_set_composition.how_to_select_designs.only_unique_designs_per_item,
                                "Only unique tiles per item"))
            combo_box.Items.Add(New KeyValuePair(Of ui.game_setup.tile_set_composition.how_to_select_designs, String)(
                                ui.game_setup.tile_set_composition.how_to_select_designs.identical_and_unique_designs_per_item,
        ...
        Public Sub list_possible_num_designs_per_item(combo_box As ComboBox,
                                                      design_selection_pattern As ui.game_setup.tile_set_composition.how_to_select_designs)
