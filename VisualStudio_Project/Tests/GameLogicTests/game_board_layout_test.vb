...
Namespace game_logic_test
    ...
    <TestClass()>
    Public Class game_board_layout_test
        ...
        Public Sub test_construction_w_valid_arguments()
            ...
            my_layout = New game_board_layout(5, game_board_layout.dimension.row, 5)

            Assert.AreEqual(game_board_layout.dimension.row, my_layout.fixed_dimension)
            Assert.AreEqual(5, my_layout.position_count)
            Assert.AreEqual(5, my_layout.row_count)

            my_layout = New game_board_layout(20, game_board_layout.dimension.row, 5)
            ...
            For number As Integer = 2 To 4
                my_layout = New game_board_layout(Math.Pow(number, 3), game_board_layout.dimension.column, number)
        ...
        Public Sub test_construction_w_invalid_arguments()
            ...
            Dim my_layout As game_board_layout

            For number As Integer = -1 To 3
                Assert.ThrowsException(Of ArgumentOutOfRangeException)(
                    Sub() my_layout = New game_board_layout(number, game_board_layout.dimension.column, 1),
                    game_board_layout.EXCEPTION_MESSAGE_LESS_THAN_FOUR_POSITIONS)
            Next

            For number As Integer = -1 To 0
                Assert.ThrowsException(Of ArgumentOutOfRangeException)(
                    Sub() my_layout = New game_board_layout(4, game_board_layout.dimension.column, number),
                    game_board_layout.EXCEPTION_MESSAGE_LESS_THAN_ONE_DIMENSION)
            Next

            Assert.ThrowsException(Of ArgumentOutOfRangeException)(
                Sub() my_layout = New game_board_layout(4, game_board_layout.dimension.column, 5),
                game_board_layout.EXCEPTION_MESSAGE_DIMENSION_LENGTH_HIGHER_THAN_POSITION_COUNT)
        ...
        Public Sub test_changing_dimensions()
            ...
            Dim my_layout As New game_board_layout(4, game_board_layout.dimension.row, 1)

            my_layout.fixed_dimension = game_board_layout.dimension.row
            Assert.AreEqual(game_board_layout.dimension.row, my_layout.fixed_dimension)
            Assert.AreEqual(1, my_layout.fixed_dimension_length)

            my_layout.fixed_dimension = game_board_layout.dimension.column
            Assert.AreEqual(game_board_layout.dimension.column, my_layout.fixed_dimension)
            Assert.AreEqual(1, my_layout.fixed_dimension_length)
        ...
        Public Sub test_changing_dimension_length()
            ...
            Dim my_layout As New game_board_layout(20, game_board_layout.dimension.row, 1)
        ...
        Public Sub test_array_position_calculation()
            ...
            Dim my_layout As New game_board_layout(9, game_board_layout.dimension.row, 3)
